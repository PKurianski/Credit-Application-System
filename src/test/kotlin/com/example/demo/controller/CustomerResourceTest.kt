...
class CustomerResourceTest {
    ...
    @Test
    fun shouldCreateCustomerAndReturn201Status() {
        //given
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Kurianski"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("kuri@email.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("2000.0"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("211562"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua do Pedro, 548"))
    ...
    @Test
    fun shouldNotSaveCustomerWithSameCPFAndReturn409Status() {
        //given
    ...
    @Test
    fun shouldNotSaveCustomerWithEmptyFirstNameAndReturn400Status() {
        //given
    ...
    fun shouldUpdateCustomerAndReturn200Status() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("KurianskiUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("kuri@email.com"))
    ...
    @Test
    fun shouldNotUpdateCustomerWithInvalidIdAndReturn400Status() {
        //given
        val invalidId: Long = Random().nextLong()
        val customerUpdateDto: CustomerUpdateDto = builderCustomerUpdateDto()
        val valueAsString: String = objectMapper.writeValueAsString(customerUpdateDto)
    ...
    private fun builderCustomerDto(
        ...
        password: String = "5468",
        zipCode: String = "211562",
        street: String = "Rua do Pedro, 548",
    ) = CustomerDto(
        firstName = firstName,
        lastName = lastName,
        cpf = cpf,
    ...
    private fun builderCustomerUpdateDto(
        ...
        lastName: String = "KurianskiUpdate",
